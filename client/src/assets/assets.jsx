...
export const platformIcons = {
  youtube: (
    <FaYoutube color="#FF0000" className="bg-[#FF000010] size-10 p-2 rounded" />
  ),
  instagram: (
    <FaInstagram
      color="#E1306C"
  ...
  tiktok: (
    <FaTiktok color="#000000" className="bg-[#00000010] size-10 p-2 rounded" />
  ),
  facebook: (
    <FaFacebookF
      color="#1877F2"
  ...
  twitter: (
    <FaXTwitter
      color="#1DA1F2"
      className="bg-[#1DA1F210] size-10 p-2 rounded"
    />
  ),
  linkedin: (
    <FaLinkedinIn
